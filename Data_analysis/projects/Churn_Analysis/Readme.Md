...
Add a new column in prod_Churn
 ...
 3.       Monthly Charge Range = if [Monthly_Charge] < 20 then “< 20” else if [Monthly_Charge] < 50 then “20-50” else if [Monthly_Charge] < 100 then “50-100” else 
   “> 100”
...
Create a new table reference for mapping_TenureGrp
 ...
 2.       Tenure Group = if [Tenure_in_Months] < 6 then “< 6 Months” else if [Tenure_in_Months] < 12 then “6-12 Months” else if [Tenure_in_Months] < 18 then “12- 
          18 Months” else if [Tenure_in_Months] < 24 then “18-24 Months” else “>= 24 Months”
...
#  Build Dashboard Or a Report:
   ...
   Shows visualizations from Churn Analysis :

   ![Churn_Analysis_Img](https://github.com/user-attachments/assets/ed9c527f-864d-41ad-a38a-e5fee678f50f)
